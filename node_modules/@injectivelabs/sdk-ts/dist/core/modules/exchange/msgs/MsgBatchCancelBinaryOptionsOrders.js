...
class MsgBatchCancelBinaryOptionsOrders extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        const orderDataList = params.orders.map((order) => {
            ...
            orderData.setOrderMask(exchange_1.OrderMask.Any);
            return orderData;
        });
        const message = new tx_pb_1.MsgBatchCancelBinaryOptionsOrders();
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgBatchCancelBinaryOptionsOrders' }, proto.toObject());
    }
    toAmino() {
        const proto = this.toProto();
