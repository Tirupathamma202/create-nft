...
export default class Wallet {
     ...
     */
    getWallet(passphrase: string): Promise<DirectSecp256k1HdWallet | DirectEthSecp256k1Wallet>;
    /**
     * Get all accounts associated with the wallet
     */
    getAccounts(passphrase: string): Promise<readonly import("@cosmjs/proto-signing").AccountData[] | readonly import("@injectivelabs/sdk-ts/dist/core/accounts/signers/types/proto-signer").AccountData[]>;
    /**
