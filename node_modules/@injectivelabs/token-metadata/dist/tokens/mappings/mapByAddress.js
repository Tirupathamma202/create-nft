...
const getMappedTokensByErc20Address = (tokens) => Object.keys(tokens)
    ...
    return Object.assign(Object.assign({}, result), { [tokens[token].erc20.address.toLowerCase()]: tokens[token] });
}, {});
...
const getMappedTokensByCw20Address = (tokens) => Object.keys(tokens)
    ...
    if (tokenMeta.cw20) {
        return Object.assign(Object.assign({}, result), { [tokenMeta.cw20.address.toLowerCase()]: tokens[token] });
    }
    if (tokenMeta.cw20s) {
        const cw20Maps = tokenMeta.cw20s.reduce((result, cw20) => (Object.assign(Object.assign({}, result), { [cw20.address.toLowerCase()]: tokens[token] })), {});
