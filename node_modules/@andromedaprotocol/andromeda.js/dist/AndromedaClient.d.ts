...
export default class AndromedaClient {
     ...
     */
    connect(endpoint: string, registryAddress: string, addressPrefix: string, signer?: OfflineSigner | OfflineDirectSigner, options?: SigningCosmWasmClientOptions): Promise<void>;
    /**
     ...
     * @returns
     */
    getSentTxsByAddress(addr: string): Promise<readonly import("@cosmjs/cosmwasm-stargate").IndexedTx[]>;
    /**
     * Gets all transactions sent to a contract
     * @param addr
     * @returns
     */
    getTxsByContract(addr: string): Promise<readonly import("@cosmjs/cosmwasm-stargate").IndexedTx[]>;
    /**
     * Gets all bank messages sent to or from an address
     * @param addr
     * @returns
     */
    getBankTxsByAddress(addr: string): Promise<readonly import("@cosmjs/cosmwasm-stargate").IndexedTx[]>;
    /**
