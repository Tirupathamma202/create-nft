...
class AndromedaClient {
    constructor() {
        ...
        this.registry = new api_1.RegistryAPI(this);
        // API for ADO DB specific messages
        this.adoDB = new api_1.ADODBAPI(this);
    }
    /**
     ...
     */
    async connect(endpoint, registryAddress, addressPrefix, signer, 
     ...
     * @returns
     */
    async assignKeyAddresses(registryAddress) {
