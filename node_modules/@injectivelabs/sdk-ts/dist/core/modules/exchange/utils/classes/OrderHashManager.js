...
const orderTypeToChainOrderType = (orderType) => {
    switch (orderType) {
        case exchange_pb_1.OrderType.BUY:
            return '\u0001';
        case exchange_pb_1.OrderType.SELL:
            return '\u0002';
        case exchange_pb_1.OrderType.STOP_BUY:
            return '\u0003';
        case exchange_pb_1.OrderType.STOP_SELL:
            return '\u0004';
        case exchange_pb_1.OrderType.TAKE_BUY:
            return '\u0005';
        case exchange_pb_1.OrderType.TAKE_SELL:
            return '\u0006';
        case exchange_pb_1.OrderType.BUY_PO:
            return '\u0007';
        case exchange_pb_1.OrderType.SELL_PO:
            return '\u0008';
        case exchange_pb_1.OrderType.BUY_ATOMIC:
            return '\u0009';
        case exchange_pb_1.OrderType.SELL_ATOMIC:
            return '\u000A';
        default:
            return '\u0001';
    }
    ...
    return {
        ...
        message: {
            ...
            TriggerPrice: spotOrder.triggerPrice
                ? (0, numbers_1.cosmosSdkDecToBigNumber)(spotOrder.triggerPrice).toFixed()
    ...
    return {
        ...
        message: {
            ...
            TriggerPrice: derivativeOrder.triggerPrice
                ? (0, numbers_1.cosmosSdkDecToBigNumber)(derivativeOrder.triggerPrice).toFixed()
                : '0.000000000000000000',
            Salt: nonce.toString(),
        },
    };
