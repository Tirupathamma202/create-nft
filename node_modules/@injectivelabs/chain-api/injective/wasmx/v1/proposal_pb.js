...
proto.injective.wasmx.v1.ContractRegistrationRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pinContract: jspb.Message.getBooleanFieldWithDefault(msg, 4, false)
  };
...
/**
 * optional bool pin_contract = 4;
 * @return {boolean}
 */
proto.injective.wasmx.v1.ContractRegistrationRequest.prototype.getPinContract = function() {
 ...
 * @return {!proto.injective.wasmx.v1.ContractRegistrationRequest} returns this
 */
proto.injective.wasmx.v1.ContractRegistrationRequest.prototype.setPinContract = function(value) {
