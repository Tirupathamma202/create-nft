...
const createMarketOrder = (params) => {
    ...
    const message = new tx_pb_1.MsgCreateBinaryOptionsMarketOrder();
...
class MsgCreateBinaryOptionsMarketOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateBinaryOptionsMarketOrder' }, proto.toObject());
    }
    toAmino() {
        const { params } = this;
