...
class ExecArgInitiateTransfer extends ExecArgBase_1.ExecArgBase {
    ...
    toData() {
        ...
        return Object.assign({ nonce: Math.round(Math.random() * 100000), asset: {
                ...
                info: params.info,
            }, recipient_chain: params.recipientChainId, recipient: (0, utils_1.binaryToBase64)(params.recipient), fee: params.relayerFee || '0' }, (params.payload && { payload: (0, utils_1.binaryToBase64)(params.payload) }));
    }
    toExecData() {
