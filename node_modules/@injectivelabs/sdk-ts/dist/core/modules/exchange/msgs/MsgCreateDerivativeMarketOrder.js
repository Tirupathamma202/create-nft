...
const createMarketOrder = (params) => {
    ...
    const message = new tx_pb_1.MsgCreateDerivativeMarketOrder();
...
class MsgCreateDerivativeMarketOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateDerivativeMarketOrder' }, proto.toObject());
    }
    toAmino() {
        const { params } = this;
