...
class TerraClient extends BaseChainClient_1.default {
    ...
    async broadcast(tx) {
        ...
        const logs = (0, logs_1.parseRawLog)(resp.raw_log);
        const codeIdAttr = (0, logs_1.findAttribute)(logs, "store_code", "code_id");
        return {
            ...resp,
            code: codeIdAttr ? parseInt(codeIdAttr.value, 10) : -1,
            transactionHash: resp.txhash,
            events: lodash_1.default.flatten(logs.map((log) => log.events)),
