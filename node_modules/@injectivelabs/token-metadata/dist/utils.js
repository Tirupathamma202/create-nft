...
exports.getUnknownToken = exports.getTokenFromMeta = exports.getCw20TokenSingle = exports.getTokenAddress = exports.getTokenDecimals = exports.getTokenSymbol = exports.getTokenTypeFromDenom = exports.getIbcTokenMetaFromDenomTrace = void 0;
    ...
    if (cw20s) {
        if (denom) {
            const [cw20Address] = denom.startsWith('inj')
                ? [denom]
                : denom.split('/').reverse();
            const cw20 = cw20s.find((cw20) => cw20.address.toLowerCase() === cw20Address.toLowerCase());
            return cw20
        ...
        if (source) {
            const cw20 = cw20s.find((cw20) => cw20.source.toLowerCase() === source.toLowerCase());
            return cw20
                ? Object.assign(Object.assign({}, token), { cw20, denom: cw20.address, symbol: cw20.symbol, tokenType: (0, exports.getTokenTypeFromDenom)(cw20.address) }) : undefined;
        }
    }
