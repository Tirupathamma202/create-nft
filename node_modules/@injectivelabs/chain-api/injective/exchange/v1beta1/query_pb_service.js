...
Query.NinjaVaultInfos = {
  methodName: "NinjaVaultInfos",
  service: Query,
  requestStream: false,
  responseStream: false,
  requestType: injective_exchange_v1beta1_query_pb.NinjaVaultInfosRequest,
  responseType: injective_exchange_v1beta1_query_pb.NinjaVaultInfosResponse
};
...
QueryClient.prototype.ninjaVaultInfos = function ninjaVaultInfos(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.NinjaVaultInfos, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
