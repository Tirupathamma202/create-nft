...
class MsgBatchCancelDerivativeOrders extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        const message = new tx_pb_1.MsgBatchCancelDerivativeOrders();
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgBatchCancelDerivativeOrders' }, proto.toObject());
    }
    toAmino() {
        const proto = this.toProto();
