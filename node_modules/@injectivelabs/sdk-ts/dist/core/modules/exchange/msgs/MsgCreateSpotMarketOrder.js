...
const createMarketOrder = (params) => {
    ...
    const spotOrder = new exchange_pb_1.SpotOrder();
    ...
    const message = new tx_pb_1.MsgCreateSpotMarketOrder();
...
class MsgCreateSpotMarketOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateSpotMarketOrder' }, proto.toObject());
    }
    toAmino() {
        const { params } = this;
