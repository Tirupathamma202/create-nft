...
type QueryNinjaVaultInfos = {
  readonly methodName: string;
  readonly service: typeof Query;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof injective_exchange_v1beta1_query_pb.NinjaVaultInfosRequest;
  readonly responseType: typeof injective_exchange_v1beta1_query_pb.NinjaVaultInfosResponse;
};
...
export class Query {
  ...
  static readonly NinjaVaultInfos: QueryNinjaVaultInfos;
...
export class QueryClient {
  ...
  ninjaVaultInfos(
    requestMessage: injective_exchange_v1beta1_query_pb.NinjaVaultInfosRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: injective_exchange_v1beta1_query_pb.NinjaVaultInfosResponse|null) => void
  ): UnaryResponse;
  ninjaVaultInfos(
    requestMessage: injective_exchange_v1beta1_query_pb.NinjaVaultInfosRequest,
    callback: (error: ServiceError|null, responseMessage: injective_exchange_v1beta1_query_pb.NinjaVaultInfosResponse|null) => void
