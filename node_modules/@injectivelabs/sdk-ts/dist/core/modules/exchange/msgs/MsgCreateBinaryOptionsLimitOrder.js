...
const createLimitOrder = (params) => {
    ...
    const message = new tx_pb_1.MsgCreateBinaryOptionsLimitOrder();
...
class MsgCreateBinaryOptionsLimitOrder extends MsgBase_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgCreateBinaryOptionsLimitOrder' }, proto.toObject());
    }
    toAmino() {
        const { params } = this;
