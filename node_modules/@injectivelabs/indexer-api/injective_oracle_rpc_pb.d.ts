...
export class StreamPricesByMarketsRequest extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StreamPricesByMarketsRequest.AsObject;
  static toObject(includeInstance: boolean, msg: StreamPricesByMarketsRequest): StreamPricesByMarketsRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StreamPricesByMarketsRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StreamPricesByMarketsRequest;
  static deserializeBinaryFromReader(message: StreamPricesByMarketsRequest, reader: jspb.BinaryReader): StreamPricesByMarketsRequest;
}

export namespace StreamPricesByMarketsRequest {
  export type AsObject = {
    marketIdsList: Array<string>,
  }
}

export class StreamPricesByMarketsResponse extends jspb.Message {
  getPrice(): string;
  setPrice(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StreamPricesByMarketsResponse.AsObject;
  static toObject(includeInstance: boolean, msg: StreamPricesByMarketsResponse): StreamPricesByMarketsResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StreamPricesByMarketsResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StreamPricesByMarketsResponse;
  static deserializeBinaryFromReader(message: StreamPricesByMarketsResponse, reader: jspb.BinaryReader): StreamPricesByMarketsResponse;
}

export namespace StreamPricesByMarketsResponse {
  export type AsObject = {
    price: string,
    timestamp: number,
    marketId: string,
