...
const OfflineDirectSigner_1 = require("@injectivelabs/sdk-ts/dist/core/accounts/signers/OfflineDirectSigner");
...
class EtherWallet extends Wallet_1.default {
    static async fromMnemonic(name, mnemonic, passphrase) {
        ...
        const wallet = ethers_1.Wallet.fromMnemonic(mnemonic, sdk_ts_1.DEFAULT_DERIVATION_PATH);
    ...
    async getWallet(passphrase) {
        ...
        return await OfflineDirectSigner_1.DirectEthSecp256k1Wallet.fromKey(privKeyArray);
    }
}
